...
class Config(object):
    ...
    OWNER    = int(os.environ.get("OWNER", "5637296836"))  # ⚠️ Required
    SUDO = list(map(int, os.environ.get("SUDO", "5637296836 5328226467").split()))  # ⚠️ Required
    # Web Response Config
...
☛ For e.g :- <code> @ </code> or <code> https:/t.me/Oogo_Nick </code>
"""
...
Tʜɪs ʙᴏᴛ ɪs sᴏʟᴇʟʏ ᴄʀᴇᴀᴛᴇ ᴏʀ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ :- @Oogo_Nick
"""
